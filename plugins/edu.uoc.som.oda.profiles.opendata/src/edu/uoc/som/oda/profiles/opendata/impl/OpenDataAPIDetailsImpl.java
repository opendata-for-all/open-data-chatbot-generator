 ...
 * </p>
 * <ul>
 *   <li>{@link edu.uoc.som.oda.profiles.opendata.impl.OpenDataAPIDetailsImpl#getBase_Class <em>Base Class</em>}</li>
 *   <li>{@link edu.uoc.som.oda.profiles.opendata.impl.OpenDataAPIDetailsImpl#getId <em>Id</em>}</li>
 *   <li>{@link edu.uoc.som.oda.profiles.opendata.impl.OpenDataAPIDetailsImpl#getName <em>Name</em>}</li>
 *   <li>{@link edu.uoc.som.oda.profiles.opendata.impl.OpenDataAPIDetailsImpl#getCategory <em>Category</em>}</li>
 *   <li>{@link edu.uoc.som.oda.profiles.opendata.impl.OpenDataAPIDetailsImpl#getDataUri <em>Data Uri</em>}</li>
 *   <li>{@link edu.uoc.som.oda.profiles.opendata.impl.OpenDataAPIDetailsImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link edu.uoc.som.oda.profiles.opendata.impl.OpenDataAPIDetailsImpl#getDomain <em>Domain</em>}</li>
 *   <li>{@link edu.uoc.som.oda.profiles.opendata.impl.OpenDataAPIDetailsImpl#getLicense <em>License</em>}</li>
 *   <li>{@link edu.uoc.som.oda.profiles.opendata.impl.OpenDataAPIDetailsImpl#getWebUri <em>Web Uri</em>}</li>
 *   <li>{@link edu.uoc.som.oda.profiles.opendata.impl.OpenDataAPIDetailsImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link edu.uoc.som.oda.profiles.opendata.impl.OpenDataAPIDetailsImpl#getApiType <em>Api Type</em>}</li>
 *   <li>{@link edu.uoc.som.oda.profiles.opendata.impl.OpenDataAPIDetailsImpl#getApiTypeVersion <em>Api Type Version</em>}</li>
 * </ul>
 *
 * @generated
 */
