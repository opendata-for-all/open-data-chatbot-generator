...
import edu.uoc.som.oda.profile.AdhocFieldType;
import edu.uoc.som.oda.profile.CKanField;
import edu.uoc.som.oda.profile.CkanFieldType;
import edu.uoc.som.oda.profile.ODataField;
import edu.uoc.som.oda.profile.ODataFieldType;
import edu.uoc.som.oda.profile.OpenDataAPIDetails;
import edu.uoc.som.oda.profile.OpenDataAPIType;
import edu.uoc.som.oda.profile.OpenDataField;
import edu.uoc.som.oda.profile.OpenDataFieldType;
import edu.uoc.som.oda.profile.OpenDataProfileFactory;
...
public class OpenDataProfilePackageImpl extends EPackageImpl implements OpenDataProfilePackage {
	 ...
	 * @see edu.uoc.som.oda.profile.OpenDataProfilePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
